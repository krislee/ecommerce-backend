...
const {loggedInAddItem, loggedInUpdateItemQuantity, loggedInDeleteItem, loggedInIndexCart, getCartItemQuantity} = require('../../controller/buyer/loggedInCart')
...
router.get('/quantity/:id', passportAuthenticate, getCartItemQuantity)
