...
const updatePaymentIntent = async(req, res) => {
    try {
        ...
        console.log(93, "updated existing payment intent: ", updatedPaymentIntent)
...
const createOrUpdatePaymentIntent = async(req, res) => {
    try {
        ...
        console.log(239, "idempotency key header value: ", req.headers['idempotency-key'])
        ...
        console.log(243, "existingPaymentIntent: ", existingPaymentIntent)
